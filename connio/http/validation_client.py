...
from connio.compat import urlparse
from connio.http import HttpClient
from connio.http.response import Response
from connio.jwt.validation import ClientValidationJwt
...
class ValidationClient(HttpClient):
    ...
    def __init__(self, account_sid, api_key_sid, credential_sid, private_key, pool_connections=True):
        """
        Build a ValidationClient which signs requests with private_key and allows Connio to
    ...
    def request(self, method, url, params=None, data=None, headers=None, auth=None, timeout=None,
        ...
        prepared_request.headers['Connio-Client-Validation'] = jwt.to_jwt()
