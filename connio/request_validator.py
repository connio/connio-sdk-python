...
from connio.compat import izip, urlparse
...
def remove_port(uri):
    ...
    :param uri: full URI that Connio requested on your server
...
class RequestValidator(object):
    ...
    def compute_signature(self, uri, params, utf=PY3):
        ...
        :param uri: full URI that Connio requested on your server
        :param params: post vars that Connio sent with the request
    ...
    def validate(self, uri, params, signature):
        """Validate a request from Connio

        :param uri: full URI that Connio requested on your server
        :param params: post vars that Connio sent with the request
        :param signature: expected signature in HTTP X-Connio-Signature header
