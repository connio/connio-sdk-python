...
`connio-python` uses a modified version of [Semantic Versioning][semver] for
...
`PATCH` versions will be reset to zero. Connio understands that this can be very
...
`connio-python` follows an evergreen model of support. New features and
