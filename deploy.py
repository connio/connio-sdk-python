...
from connio import __version_info__, __version__
...
def main(version):
    ...
    print('Updating connio/__init__.py ... ', end="")
    with open('connio/__init__.py', 'w') as init_file:
    ...
    os.system('open "https://pypi.python.org/pypi?:action=pkg_edit&name=connio"')
