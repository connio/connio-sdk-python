...
def wire(client, name='LogikaL33', friendly="Logika L33 Controller", base="BaseLogikaProfile"):
    ...
    client.account.properties(compressor.id).create(name="D1", data_type='object', access_type='protected', publish_type='never')
    client.account.properties(compressor.id).create(name="D3", data_type='object', access_type='protected', publish_type='never')
    client.account.properties(compressor.id).create(name="D6", data_type='object', access_type='protected', publish_type='never')
    client.account.properties(compressor.id).create(name="D7", data_type='object', access_type='protected', publish_type='never')
    ...
    client.account.methods(compressor.id).create(name='readV0x', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('V0')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readD6', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('D6')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readD7', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('D7')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readD1', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('D1')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readD3', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('D3')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readS12_S13_S14', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('S12')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readS02', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('S02')), access_type=accessLevel4)
    ...
    client.account.methods(compressor.id).create(name='readS08_09', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('S08')), access_type=accessLevel4)
    ...
    client.account.methods(compressor.id).create(name='readS15', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('S15')), access_type=accessLevel4)
    client.account.methods(compressor.id).create(name='readS21_S22', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('S21')), access_type=accessLevel4)
