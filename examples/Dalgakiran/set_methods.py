...
let result = [];
if (outputMap & 1) result.push("0x0001");
if (outputMap & 2) result.push("0x0002");
if (outputMap & 4) result.push("0x0004");
if (outputMap & 8) result.push("0x0008");
if (outputMap & 16) result.push("0x0010");
if (outputMap & 32) result.push("0x0020");
if (outputMap & 64) result.push("0x0040");
if (outputMap & 128) result.push("0x0080");
if (outputMap & 256) result.push("0x0100");
if (outputMap & 512) result.push("0x0200");
if (outputMap & 1024) result.push("0x0400");
if (outputMap & 2048) result.push("0x0800");
if (outputMap & 4096) result.push("0x1000");
