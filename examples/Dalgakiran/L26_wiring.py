...
def wire(client):
    ...
    client.account.methods(compressor.id).create(name='readC2x', method_impl= MethodInstance.MethodImplementation(readTagIntoProperty_body('C22')), access_type=accessLevel4)
    ...
    client.account.methods(compressor.id).create(name='writeC19_x', method_impl= MethodInstance.MethodImplementation(setC19x_body()), access_type=accessLevel4)
    ...
    client.account.methods(compressor.id).create(name='writeC2x', method_impl= MethodInstance.MethodImplementation(setC22_body()), access_type=accessLevel4)
