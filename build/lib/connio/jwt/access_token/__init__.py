...
from connio.jwt import Jwt


class AccessTokenGrant(object):
    """A Grant giving access to a Connio Resource"""
    @property
    def key(self):
...
class AccessToken(Jwt):
    """Access Token containing one or more AccessTokenGrants used to access Connio Resources"""
