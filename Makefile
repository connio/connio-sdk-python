...
analysis:
	...
	. venv/bin/activate; flake8 --ignore=E402,F401,W391,W291,W293 connio --max-line-length=300
...
cover:
	. venv/bin/activate; \
  find tests -type d | xargs nosetests --with-coverage --cover-inclusive --cover-erase --cover-package=connio

docs-install:
	. venv/bin/activate; pip install pdoc

docs:
	. venv/bin/activate; pdoc connio --overwrite --html --html-dir docs
